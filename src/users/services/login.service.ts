import { STORAGE_BRANCH, STORAGE_TOKEN, STORAGE_USER, fetchData, setStorage } from '@utils/index'
import { type AuthLogin } from '../models/login.model'
import { User } from '../models/user.model'

const userLogin = async (url: string, { arg }: { arg: AuthLogin }): Promise<User> => {
...
const checkToken = async (url: string, { arg }: { arg: { token: string } }): Promise<unknown> => {
